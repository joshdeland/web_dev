...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "sp23_3308_tuo07755?user=tuo07755&password=reishuni";
        ...
        try {
            ...
            try {
                ...
                recordError("Problem connecting to the database. Please try later"
                        + " or contact your administrator. Error: " + e.getMessage());
            }
        } catch (Exception e) { // cant get the driver...
            recordError("Problem getting the database driver. Please try later"
                        + " or contact your administrator. Error: " + e.getMessage());
        }
    } // method
    ...
    private void recordError(String errorMsg) {
        ...
        System.out.println("Error in obtaining records from the database. Please try later"
                        + " or contact your administrator. Error: " + errorMsg);
    }
    ...
    private boolean isTemple() {
        ...
        try {
            ...
            recordError("Unable to get hostName of the database. Please try later"
                        + " or contact your administrator. Error: " + e.getMessage());
        }
        return temple;
    }
